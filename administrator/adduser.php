...
<html>
  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <div class="row" style="padding-top: 0px; margin-top: 20px;">
        ...
        <div class="col-sm-9" style="padding-top: 0px;" id="loginPane">
          <a href="../useraccount/" class="btn btn-app-teal btn-custom" style="font-size: 22px; padding: 5px 10px 0px 10px;">ย้อนกลับ</a>
                                        ...
                                        <form class="js-validation-material form-horizontal m-t-sm" action="../../controller/user-insert.php" method="post">
                                          <div class="row">
                                              ...
                                              <div class="form-group">
                                                  <div class="col-sm-12">
                                                      <div class="form-material">
                                                          <input class="form-control" type="text" id="val-username" name="val-username" placeholder="กรอกชื่อบัญชีผู้ใช้งาน ..."  value="" />
                                                          <label for="val-username2">Username <span style="color: red;">**</span></label>
                                                      </div>
                                                  </div>
                                              </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                              <div class="form-group">
                                                  <div class="col-sm-12">
                                                      <div class="form-material">
                                                          <input class="form-control" type="text" id="val-password" name="val-password" placeholder="กรอกรหัสผ่าน..."  value="" />
                                                          <label for="val-username2">Password <span style="color: red;">**</span></label>
                                                      </div>
                                                  </div>
                                              </div>
                                            </div>
                                              ...
                                              <div class="col-sm-12">
                                                  <div class="form-material">
                                                      <select class="form-control" id="val-role" name="val-role">
                                                        ...
                                                        <option value="3" >Coordinator staff</option>
                                                      </select>
                                                      <label for="val-skill2">Role <span style="color: red;">**</span></label>
                                                  </div>
                                              </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="row">
                                              ...
                                              <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        <div class="form-material">
                                                            <input class="form-control" type="text" id="val-fname" name="val-fname" placeholder="กรอกชื่อจริง ..." value="" />
                                              ...
                                              <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        <div class="form-material">
                                                            <input class="form-control" type="text" id="val-lname" name="val-lname" placeholder="กรอกนามสกุล ..." value="" />
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <div class="form-material">
                                                        <input class="form-control" type="text" id="val-phone" name="val-phone" placeholder="กรอกหมายเลขโทรศัพท์ ..." value="" />
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <div class="form-material">
                                                        <input class="form-control" type="text" id="val-email" name="val-email" placeholder="กรอกอีเมลแอดเดรส..."  value="" />
    ...
    <!-- Page JS Code -->
    <script src="../../dist/page/administrator/adduser/forms_validation.js"></script>
