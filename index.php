      ...
      <div class="modal-dialog modal-lg">
          <div class="modal-content">
              ...
              <div class="card-block" style="font-size: 24px;">
                ...
                <ol>
                  <li>นักศึกษาที่ประสงค์จะฝึกงานภาคฤดูร้อนต้องกรอกข้อมูลในระบบฯ เท่านั้น และกรอกข้อมูลในช่องว่างให้ครบถ้วน หรือ กรอกข้อมูลในช่องที่มีสัญลักษณ์  <span style="color:red; font-weight: bold;">**</span></li>
                  <li>กรอกข้อมูลให้ครบถ้วน แล้วจึงทำการกดปุ่ม  <span style="color:red; font-weight: bold;">"บันทึกข้อมูล"</span> หลังจากบันทึกข้อมูลแล้วข้อมูลดังกล่าวจะไม่สามารถแก้ไขข้อมูลได้แล้ว หากต้องการแก้ไข รบกวนติดต่อเจ้าหน้าที่ผู้ประสานงานเพื่อดำเนินการต่อไป</li>
                  <li>หลังจากระบบฯ เพิ่มใบสมัครเรียบร้อยแล้ว ระบบจะเข้าสู่ระบบโดยอัตโนมัติ ให้นักศึกษาดำเนินการ<span style="color:red; font-weight: bold;">เปลี่ยนรหัสผ่านทันที</span> ซึ่งใช้ในการเข้าสู่ระบบในครั้งถัดไป เพื่อติดตามสถานะใบสมัครฝึกงานภาคฤดูร้อนของนักศึกษาเอง</li>
                  <li>ให้นักศึกษาทุกท่านอัพโหลดรูปของนักศึกษาเองนะคะ (ไม่จำเป็นต้องเป็นรูปนักศึกษา แต่ขอรูปที่สุภาพ) </li>
