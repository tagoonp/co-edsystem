...
(15, 'หน่วยระบาดวิทยา', 'คณะแพทยศาสตร์', '7tkn33umrqnac57icijckrejm0', '5410991191', '2016-10-22');
...
(14, 'asd', 'ad', 'd0ub05vn8vo7ma3a2ggnnpa0s7', '1231231231', '2016-10-22'),
(15, 'asd', 'asd', 'eva78422so8tbkjv5eruobuuu7', '', '2016-10-22'),
(16, 'asd', 'asd', '1l4ded4u9fsn3sn80sas0vece7', '', '2016-10-22'),
(17, 'asd', 'asd', 'ue1qehqvuls6jn0009eugm82d1', '', '2016-10-22'),
(18, 'asd', 'asd', 'kpta0orp6jrk3itst3mlf929o6', '', '2016-10-22'),
(19, 'asd', 'asd', '9962mpf66v0ntj3oa6pvg2dbv3', '', '2016-10-22'),
(20, 'asd', 'asd', '9962mpf66v0ntj3oa6pvg2dbv3', '', '2016-10-22'),
(24, 'asd', 'asd2', '5drttp3n3rqr4vrrr0r1q7erm3', '', '2016-10-22');
...
(4, '2016-12-12', '2017-03-01', 'Yes', 'qswe', 'Agree', '1234', 'administrator', '2016-10-10', '2016-10-20', '1111111111'),
...
(8, '0000-00-00', '0000-00-00', 'No', '', 'Waiting', '', '', '2016-10-22', '0000-00-00', '5410991191');
...
(26, '2559', '5410991191', 'ณัฐตินา วิชัยดิษฐ', 'Nattina Wichaidith', 'profile-2016-10-22-11-07-20Photo(1).jpg', '1987-06-12', 29, '1', 'ไทย', 'ไทย', '0923313131', 'asd@gmail.com', '13/2', '2.13', 'ฐากูร ปราบปรี', 'สามี', '0941171631', '0000-00-00', '0000-00-00', '', '', '', '', '', '', '2', '', '', '', '2016-10-22', 'Y');
...
('5410991191', '5715ee603c726fdfb23fa255f730d702', 'asd@gmail.com', 4, 'Y', '2016-10-22'),
...
('administrator', '2e1ed0fb3968e9fa82b249dc052ee9e4', 'tagoon.p@gmail.com', 1, 'Y', '2016-09-20');
...
(7, '', 'Nattina', 'Wichaidith', '0923313131', '5410991191');
...
(29, '2016-10-13', '14:39:15', 'เข้าใช้งานระบบ', 'Success', 'administrator', 'administrator'),
(30, '2016-10-19', '15:24:14', 'เข้าใช้งานระบบ', 'Success', 'administrator', 'administrator'),
(31, '2016-10-20', '20:18:21', 'เข้าใช้งานระบบ', 'Success', 'administrator', 'administrator'),
(32, '2016-10-20', '20:25:13', 'เปลี่ยนรหัสผ่าน', 'Success', 'administrator', 'administrator'),
(33, '2016-10-20', '20:26:57', 'เปลี่ยนรหัสผ่าน', 'Success', 'administrator', 'administrator'),
(34, '2016-10-20', '20:27:45', 'ตอบรับความเห็น - Agree', 'Success', 'administrator', '1111111111'),
(35, '2016-10-20', '20:27:45', 'ตอบรับความเห็น - เห็นสมควร', 'Success', '1111111111', '1111111111'),
(36, '2016-10-20', '20:27:55', 'ออกจากระบบ', 'Success', 'administrator', 'administrator'),
(37, '2016-10-20', '20:28:03', 'เข้าใช้งานระบบ', 'Success', '1111111111', '1111111111'),
(38, '2016-10-22', '01:29:38', 'เข้าใช้งานระบบ', 'Fail', 'administrator', 'administrator'),
(39, '2016-10-22', '01:29:48', 'เข้าใช้งานระบบ', 'Fail', 'administrator', 'administrator'),
(40, '2016-10-22', '01:29:54', 'เข้าใช้งานระบบ', 'Success', 'administrator', 'administrator'),
(41, '2016-10-22', '08:38:48', 'เข้าใช้งานระบบ', 'Fail', '5312323232', '5312323232'),
(42, '2016-10-22', '08:38:51', 'เข้าใช้งานระบบ', 'Fail', '5312323232', '5312323232'),
(43, '2016-10-22', '08:38:57', 'เข้าใช้งานระบบ', 'Fail', '5312323232', '5312323232'),
(44, '2016-10-22', '08:39:01', 'เข้าใช้งานระบบ', 'Fail', '5312323232', '5312323232'),
(45, '2016-10-22', '08:39:09', 'เข้าใช้งานระบบ', 'Fail', '5312323232', '5312323232'),
(46, '2016-10-22', '08:39:11', 'เข้าใช้งานระบบ', 'Fail', '5312323232', '5312323232'),
(47, '2016-10-22', '08:39:30', 'เข้าใช้งานระบบ', 'Fail', '5312323232', '5312323232'),
(48, '2016-10-22', '08:39:42', 'เข้าใช้งานระบบ', 'Success', '1111111112', '1111111112'),
(49, '2016-10-22', '08:39:55', 'ออกจากระบบ', 'Success', '1111111112', '1111111112'),
(50, '2016-10-22', '08:43:27', 'สมัครฝึกงานภาคฤดูร้อน', 'Success', '5410991191', '5410991191'),
(51, '2016-10-22', '08:43:27', 'สร้างบัญชีผู้ใช้งาน', 'Success', '5410991191', '5410991191'),
(52, '2016-10-22', '08:43:28', 'เข้าใช้งานระบบ', 'Success', '5410991191', '5410991191'),
(53, '2016-10-22', '10:18:19', 'อัพโหลดรูปประจำตัว', 'Success', '5410991191', '5410991191'),
(54, '2016-10-22', '10:19:50', 'อัพโหลดรูปประจำตัว', 'Success', '5410991191', '5410991191'),
(55, '2016-10-22', '10:20:18', 'อัพโหลดรูปประจำตัว', 'Success', '5410991191', '5410991191'),
(56, '2016-10-22', '10:21:10', 'อัพโหลดรูปประจำตัว', 'Success', '5410991191', '5410991191'),
(57, '2016-10-22', '10:38:24', 'อัพโหลดรูปประจำตัว', 'Success', '5410991191', '5410991191'),
(58, '2016-10-22', '10:38:53', 'ยืนยันการสมัคร', 'Success', '5410991191', '5410991191'),
(59, '2016-10-22', '11:03:54', 'อัพโหลดรูปประจำตัว', 'Success', '5410991191', '5410991191'),
(60, '2016-10-22', '11:04:21', 'อัพโหลดรูปประจำตัว', 'Success', '5410991191', '5410991191'),
(61, '2016-10-22', '11:06:20', 'อัพโหลดรูปประจำตัว', 'Success', '5410991191', '5410991191'),
(62, '2016-10-22', '11:07:20', 'อัพโหลดรูปประจำตัว', 'Success', '5410991191', '5410991191'),
(63, '2016-10-22', '17:17:08', 'ออกจากระบบ', 'Success', 'administrator', 'administrator');
...
--
ALTER TABLE `trs3_department`
  MODIFY `tmp_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT for table `trs3_department_temporary`
--
ALTER TABLE `trs3_department_temporary`
  MODIFY `tmp_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
-- AUTO_INCREMENT for table `trs3_disease`
--
ALTER TABLE `trs3_disease`
  MODIFY `di_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
--
-- AUTO_INCREMENT for table `trs3_questioniar`
--
ALTER TABLE `trs3_questioniar`
  MODIFY `qn_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `trs3_registration`
--
ALTER TABLE `trs3_registration`
  MODIFY `registration_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
--
-- AUTO_INCREMENT for table `trs3_userinfo`
--
ALTER TABLE `trs3_userinfo`
  MODIFY `userinfo_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `trs3_usertransection`
--
ALTER TABLE `trs3_usertransection`
  MODIFY `t_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
--
